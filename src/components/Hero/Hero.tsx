  ...
  return (
    <main>
      <p>
        Hello, my name is{' '}
        <Link
          url='https://en.wikipedia.org/wiki/Jonas_(name)'
          text='Jonas'
      ...
      <h2>Socials</h2>
      <p>
        <Link url='https://twitter.com/jvnxs7' text='jvnxs7' /> on Twitter{' '}
        <i className='fab fa-twitter'></i>
      </p>
      <p>
        <Link url='https://github.com/jonasrdl' text='jonasrdl' /> on GitHub{' '}
        <i className='fab fa-github'></i>
      </p>
      <p>
        <Link url='https://keybase.io/jonasrdl' text='jonasrdl' /> on Keybase{' '}
        <i className='fab fa-keybase'></i>
      </p>
      <p>
        <Link
          url='https://discord.com/users/209945797918195712'
          text='jvnxs7#6969'
        />{' '}
