...
const Hero = () => {
  return (
    <main>
      ...
      <p>
        <a href="https://github.com/jonasrdl">jonasrdl</a> on GitHub{' '}
        <i className="fab fa-github"></i>
      </p>
      <p>
        <a href="https://keybase.io/jonasrdl">jonasrdl</a> on Keybase{' '}
        <i className="fab fa-keybase"></i>
      </p>
      <p>
        <a href="https://discord.com/users/209945797918195712">jvnxs7#6969</a> on Discord{' '}
